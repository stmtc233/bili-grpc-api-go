...
type RelationInterfaceClient interface {
	...
	ModifyRelation(ctx context.Context, in *FollowingReq, opts ...grpc.CallOption) (*ModifyRelationReply, error)
}
...
func (c *relationInterfaceClient) AtSearch(ctx context.Context, in *AtSearchReq, opts ...grpc.CallOption) (*AtSearchReply, error) {
	...
	err := c.cc.Invoke(ctx, "/bilibili.relation.interface.v1.RelationInterface/AtSearch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationInterfaceClient) ModifyRelation(ctx context.Context, in *FollowingReq, opts ...grpc.CallOption) (*ModifyRelationReply, error) {
	out := new(ModifyRelationReply)
	err := c.cc.Invoke(ctx, "/bilibili.relation.interface.v1.RelationInterface/ModifyRelation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RelationInterfaceServer interface {
	...
	ModifyRelation(context.Context, *FollowingReq) (*ModifyRelationReply, error)
...
func (UnimplementedRelationInterfaceServer) ModifyRelation(context.Context, *FollowingReq) (*ModifyRelationReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ModifyRelation not implemented")
}
...
func RegisterRelationInterfaceServer(s *grpc.Server, srv RelationInterfaceServer) {
	s.RegisterService(&_RelationInterface_serviceDesc, srv)
}
...
func _RelationInterface_AtSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.relation.interface.v1.RelationInterface/AtSearch",
	}
...
func _RelationInterface_ModifyRelation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FollowingReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RelationInterfaceServer).ModifyRelation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bilibili.relation.interface.v1.RelationInterface/ModifyRelation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RelationInterfaceServer).ModifyRelation(ctx, req.(*FollowingReq))
	}
	return interceptor(ctx, in, info, handler)
}

var _RelationInterface_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RelationInterface_ModifyRelation_Handler,
		},
	},
