...
func (c *relationInterfaceClient) ModifyRelation(ctx context.Context, in *FollowingReq, opts ...grpc.CallOption) (*ModifyRelationReply, error) {
	...
	err := c.cc.Invoke(ctx, RelationInterface_ModifyRelation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RelationInterface_ModifyRelation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RelationInterface_ModifyRelation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RelationInterface_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "bilibili/relation/interfaces/services.proto",
}
