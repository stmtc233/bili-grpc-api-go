...
type GalleryInterfaceClient interface {
	...
	GetBanners(ctx context.Context, in *GetBannersReq, opts ...grpc.CallOption) (*GetBannersReply, error)
	...
	MinePage(ctx context.Context, in *MinePageReq, opts ...grpc.CallOption) (*MinePageReply, error)
...
func (c *galleryInterfaceClient) GetBanners(ctx context.Context, in *GetBannersReq, opts ...grpc.CallOption) (*GetBannersReply, error) {
	out := new(GetBannersReply)
	err := c.cc.Invoke(ctx, GalleryInterface_GetBanners_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *galleryInterfaceClient) MinePage(ctx context.Context, in *MinePageReq, opts ...grpc.CallOption) (*MinePageReply, error) {
	out := new(MinePageReply)
	err := c.cc.Invoke(ctx, GalleryInterface_MinePage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GalleryInterfaceServer interface {
	...
	GetBanners(context.Context, *GetBannersReq) (*GetBannersReply, error)
	...
	MinePage(context.Context, *MinePageReq) (*MinePageReply, error)
...
func (UnimplementedGalleryInterfaceServer) GetBanners(context.Context, *GetBannersReq) (*GetBannersReply, error) {
...
func (UnimplementedGalleryInterfaceServer) MinePage(context.Context, *MinePageReq) (*MinePageReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MinePage not implemented")
}
...
func _GalleryInterface_GetBanners_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBannersReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GalleryInterfaceServer).GetBanners(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GalleryInterface_GetBanners_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GalleryInterfaceServer).GetBanners(ctx, req.(*GetBannersReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GalleryInterface_MinePage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MinePageReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GalleryInterfaceServer).MinePage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GalleryInterface_MinePage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GalleryInterfaceServer).MinePage(ctx, req.(*MinePageReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GalleryInterface_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GalleryInterface_GetBanners_Handler,
		},
		{
		...
		{
			MethodName: "MinePage",
			Handler:    _GalleryInterface_MinePage_Handler,
		},
		{
			MethodName: "Ping",
	...
	Metadata: "bilibili/pangu/gallery/v1/services.proto",
}
