...
const (
	DM_DmExpoReport_FullMethodName   = "/com.bapis.bilibili.community.service.dm.v1.DM/DmExpoReport"
	DM_DmPlayerConfig_FullMethodName = "/com.bapis.bilibili.community.service.dm.v1.DM/DmPlayerConfig"
	DM_DmSegCache_FullMethodName     = "/com.bapis.bilibili.community.service.dm.v1.DM/DmSegCache"
	DM_DmSegMobile_FullMethodName    = "/com.bapis.bilibili.community.service.dm.v1.DM/DmSegMobile"
	DM_DmSegOtt_FullMethodName       = "/com.bapis.bilibili.community.service.dm.v1.DM/DmSegOtt"
	DM_DmSegSDK_FullMethodName       = "/com.bapis.bilibili.community.service.dm.v1.DM/DmSegSDK"
	DM_DmView_FullMethodName         = "/com.bapis.bilibili.community.service.dm.v1.DM/DmView"
)
...
type DMClient interface {
	...
	DmSegCache(ctx context.Context, in *DmSegCacheReq, opts ...grpc.CallOption) (*DmSegMobileReply, error)
...
func (c *dMClient) DmSegCache(ctx context.Context, in *DmSegCacheReq, opts ...grpc.CallOption) (*DmSegMobileReply, error) {
	out := new(DmSegMobileReply)
	err := c.cc.Invoke(ctx, DM_DmSegCache_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DMServer interface {
	...
	DmSegCache(context.Context, *DmSegCacheReq) (*DmSegMobileReply, error)
...
func (UnimplementedDMServer) DmSegCache(context.Context, *DmSegCacheReq) (*DmSegMobileReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DmSegCache not implemented")
}
...
func _DM_DmSegCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DmSegCacheReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DMServer).DmSegCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DM_DmSegCache_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DMServer).DmSegCache(ctx, req.(*DmSegCacheReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DM_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.bapis.bilibili.community.service.dm.v1.DM",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DmSegCache",
			Handler:    _DM_DmSegCache_Handler,
		},
		{
	...
	Metadata: "bilibili/community/service/dm/v1/services.proto",
}
