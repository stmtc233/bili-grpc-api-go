...
const (
	NativePage_WatchNotify_FullMethodName = "/com.bapis.bilibili.broadcast.message.main.NativePage/WatchNotify"
)
...
var NativePage_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.bapis.bilibili.broadcast.message.main.NativePage",
	...
	Metadata: "bilibili/broadcast/message/main/services.proto",
}

const (
	Resource_TopActivity_FullMethodName = "/com.bapis.bilibili.broadcast.message.main.Resource/TopActivity"
)
...
var Resource_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.bapis.bilibili.broadcast.message.main.Resource",
...
const (
	Search_ChatResultPush_FullMethodName = "/com.bapis.bilibili.broadcast.message.main.Search/ChatResultPush"
)
...
var Search_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.bapis.bilibili.broadcast.message.main.Search",
