...
type RankClient interface {
	...
	RankRegionList(ctx context.Context, in *RankRegionListReq, opts ...grpc.CallOption) (*RankRegionListReply, error)
}
...
func (c *rankClient) RankRegionList(ctx context.Context, in *RankRegionListReq, opts ...grpc.CallOption) (*RankRegionListReply, error) {
	out := new(RankRegionListReply)
	err := c.cc.Invoke(ctx, Rank_RankRegionList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RankServer interface {
	...
	RankRegionList(context.Context, *RankRegionListReq) (*RankRegionListReply, error)
...
func (UnimplementedRankServer) RankRegionList(context.Context, *RankRegionListReq) (*RankRegionListReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RankRegionList not implemented")
}
...
func _Rank_RankRegionList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RankRegionListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RankServer).RankRegionList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Rank_RankRegionList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RankServer).RankRegionList(ctx, req.(*RankRegionListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Rank_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RankRegionList",
			Handler:    _Rank_RankRegionList_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "bilibili/app/show/rank/v1/services.proto",
}
