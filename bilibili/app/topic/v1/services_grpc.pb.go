...
const (
	Topic_ReportUserCloseFeedCard_FullMethodName        = "/com.bapis.bilibili.app.topic.v1.Topic/ReportUserCloseFeedCard"
	Topic_ReportUserRatingFeedCardChoice_FullMethodName = "/com.bapis.bilibili.app.topic.v1.Topic/ReportUserRatingFeedCardChoice"
	Topic_SetTopTopicRes_FullMethodName                 = "/com.bapis.bilibili.app.topic.v1.Topic/SetTopTopicRes"
	Topic_TopicDetailsAll_FullMethodName                = "/com.bapis.bilibili.app.topic.v1.Topic/TopicDetailsAll"
	Topic_TopicDetailsFold_FullMethodName               = "/com.bapis.bilibili.app.topic.v1.Topic/TopicDetailsFold"
	Topic_TopicMergedResource_FullMethodName            = "/com.bapis.bilibili.app.topic.v1.Topic/TopicMergedResource"
	Topic_TopicReserveButtonClick_FullMethodName        = "/com.bapis.bilibili.app.topic.v1.Topic/TopicReserveButtonClick"
	Topic_TopicSetDetails_FullMethodName                = "/com.bapis.bilibili.app.topic.v1.Topic/TopicSetDetails"
)
...
type TopicClient interface {
	ReportUserCloseFeedCard(ctx context.Context, in *ReportUserCloseFeedCardReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	ReportUserRatingFeedCardChoice(ctx context.Context, in *ReportUserRatingFeedCardChoiceReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	SetTopTopicRes(ctx context.Context, in *SetTopTopicResReq, opts ...grpc.CallOption) (*SetTopTopicResReply, error)
...
func (c *topicClient) ReportUserCloseFeedCard(ctx context.Context, in *ReportUserCloseFeedCardReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Topic_ReportUserCloseFeedCard_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicClient) ReportUserRatingFeedCardChoice(ctx context.Context, in *ReportUserRatingFeedCardChoiceReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Topic_ReportUserRatingFeedCardChoice_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicClient) SetTopTopicRes(ctx context.Context, in *SetTopTopicResReq, opts ...grpc.CallOption) (*SetTopTopicResReply, error) {
	out := new(SetTopTopicResReply)
	err := c.cc.Invoke(ctx, Topic_SetTopTopicRes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicClient) TopicMergedResource(ctx context.Context, in *TopicMergedResourceReq, opts ...grpc.CallOption) (*TopicMergedResourceReply, error) {
	...
	err := c.cc.Invoke(ctx, Topic_TopicMergedResource_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicClient) TopicReserveButtonClick(ctx context.Context, in *TopicReserveButtonClickReq, opts ...grpc.CallOption) (*TopicReserveButtonClickReply, error) {
	...
	err := c.cc.Invoke(ctx, Topic_TopicReserveButtonClick_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TopicServer interface {
	ReportUserCloseFeedCard(context.Context, *ReportUserCloseFeedCardReq) (*emptypb.Empty, error)
	ReportUserRatingFeedCardChoice(context.Context, *ReportUserRatingFeedCardChoiceReq) (*emptypb.Empty, error)
	SetTopTopicRes(context.Context, *SetTopTopicResReq) (*SetTopTopicResReply, error)
...
func (UnimplementedTopicServer) ReportUserCloseFeedCard(context.Context, *ReportUserCloseFeedCardReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportUserCloseFeedCard not implemented")
}
func (UnimplementedTopicServer) ReportUserRatingFeedCardChoice(context.Context, *ReportUserRatingFeedCardChoiceReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportUserRatingFeedCardChoice not implemented")
}
func (UnimplementedTopicServer) SetTopTopicRes(context.Context, *SetTopTopicResReq) (*SetTopTopicResReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetTopTopicRes not implemented")
}
...
func (UnimplementedTopicServer) TopicMergedResource(context.Context, *TopicMergedResourceReq) (*TopicMergedResourceReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TopicMergedResource not implemented")
}
func (UnimplementedTopicServer) TopicReserveButtonClick(context.Context, *TopicReserveButtonClickReq) (*TopicReserveButtonClickReply, error) {
...
func _Topic_ReportUserCloseFeedCard_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportUserCloseFeedCardReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopicServer).ReportUserCloseFeedCard(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Topic_ReportUserCloseFeedCard_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopicServer).ReportUserCloseFeedCard(ctx, req.(*ReportUserCloseFeedCardReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Topic_ReportUserRatingFeedCardChoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportUserRatingFeedCardChoiceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopicServer).ReportUserRatingFeedCardChoice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Topic_ReportUserRatingFeedCardChoice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopicServer).ReportUserRatingFeedCardChoice(ctx, req.(*ReportUserRatingFeedCardChoiceReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Topic_SetTopTopicRes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetTopTopicResReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TopicServer).SetTopTopicRes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Topic_SetTopTopicRes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TopicServer).SetTopTopicRes(ctx, req.(*SetTopTopicResReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Topic_TopicMergedResource_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Topic_TopicMergedResource_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Topic_TopicReserveButtonClick_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Topic_TopicReserveButtonClick_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Topic_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.bapis.bilibili.app.topic.v1.Topic",
	HandlerType: (*TopicServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ReportUserCloseFeedCard",
			Handler:    _Topic_ReportUserCloseFeedCard_Handler,
		},
		{
			MethodName: "ReportUserRatingFeedCardChoice",
			Handler:    _Topic_ReportUserRatingFeedCardChoice_Handler,
		},
		{
			MethodName: "SetTopTopicRes",
			Handler:    _Topic_SetTopTopicRes_Handler,
		},
		{
	...
	Metadata: "bilibili/app/topic/v1/services.proto",
}
